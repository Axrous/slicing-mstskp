    ...
    <div className="bg-hero h-[1370px]">
      <div className="container mx-auto relative">
        ...
        <div className="text-center mt-20">
          ...
          <h1 className="text-[62px] text-white w-7/12 mx-auto leading-snug mt-5">
            Social Media Tool Yang Tidak Akan Memberikan Kamu Insight Apapun
          </h1>
          <p className="text-lg text-white w-6/12 mx-auto leading-9 font-mono mt-6">
          ...
          <div className="mt-14">
            ...
            <Button variant="no-border" className="px-8 py-5">
              Pelajarin Dulu
            </Button>
          </div>
        </div>
